...
public class LSAipClientConst {
    public static final Integer BCE_AUTH_EXPIRE_IN_SECONDS = 1800;
    public static final HashSet<String> BCE_HEADER_TO_SIGN = new HashSet(Arrays.asList("host","content-md5","content-length","content-type"));
